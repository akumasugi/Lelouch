...
export default class Command extends BaseCommand {
	...
	run = async (
		...
		const gifs = [
			"https://c.tenor.com/J5jHQpL-e4wAAAPo/lelouch-anime.mp4",
			"https://c.tenor.com/hh2DqIVaTk8AAAPo/lelouch.mp4",
			"https://c.tenor.com/7ZWiovx1cRcAAAPo/lelouch-vi-britannia.mp4",
		];
